      ...
      >
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            name="address"
            label="Address"
            placeholder="123th Street Metro Manila"
          />
          <CustomFormField
            control={form.control}
            fieldType={FormFieldType.INPUT}
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            placeholder="Shrimp, Peanut, Pollen"
          />
          <CustomFormField
            control={form.control}
            fieldType={FormFieldType.TEXTAREA}
            ...
            placeholder="Ibruprofen, Anlodipin"
          />
        </div>
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            placeholder="Mother had a heart disease"
          />
          <CustomFormField
            control={form.control}
            fieldType={FormFieldType.TEXTAREA}
